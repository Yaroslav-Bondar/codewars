...
// return winnerList.reduce( (prev,item) => prev+(item.country==country ? 1 : 0),0);
console.log(winnerList.reduce( (prev,item) => prev+(item.country==country ? 1 : 0),0));
}
countWins(winnerList1,'Germany');
...
ALGORITHMSSTRINGSARRAYSDATA STRUCTURESOBJECTS */