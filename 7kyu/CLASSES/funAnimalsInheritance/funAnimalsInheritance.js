...
// let shark = new Shark('Dilla', 12, 'OK')
// console.log(shark.introduce()) 
// let cat = new Cat('Pylau', 10, 'OK')
// console.log(cat.introduce())
let dog = new Dog('Koss', 1, 'OK', 'igor')
...
FUNDAMENTALSCLASSESBASIC LANGUAGE FEATURESOBJECT-ORIENTED PROGRAMMINGES2015BABEL
*/